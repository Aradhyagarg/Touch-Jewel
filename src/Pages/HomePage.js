...
const HomePage = ({ setCurrentPage }) => {
    const products = [
      { id: 1, name: 'Lab Diamond Eternity Ring', price: '₹ 95,000', image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=400&q=80' },
      { id: 2, name: 'Petite Stud Earrings', price: '₹ 45,000', image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=400&q=80' },
      { id: 3, name: 'Diamond Tennis Necklace', price: '₹ 1,85,000', image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=400&q=80' },
      { id: 4, name: 'Classic Diamond Bracelet', price: '₹ 75,000', image: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=400&q=80' },
      { id: 5, name: 'Halo Stud Earrings', price: '₹ 65,000', image: 'https://images.unsplash.com/photo-1630019852942-f89202989a59?w=400&q=80' },
      { id: 6, name: 'Solitaire Pendant', price: '₹ 1,25,000', image: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=400&q=80' }
    ];
                ...
                <div key={product.id} className="group cursor-pointer">
                  <div className="relative aspect-square bg-gray-100 rounded-lg overflow-hidden mb-4">
                    <img 
                      ...
                      className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                    />
                    <button className="absolute top-3 right-3 bg-white w-8 h-8 rounded-full flex items-center justify-center hover:bg-pink-50 transition-colors">
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex max-w-md mx-auto gap-2">
              ...
              />
              <button className="bg-red-900 text-white px-6 py-3 rounded-md hover:bg-red-800">
                →
              </button>
            </div>
          </div>
